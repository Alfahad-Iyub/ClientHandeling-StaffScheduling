...
class allChatPage extends StatefulWidget {
  ...
  const allChatPage({Key? key, required this.username}) : super(key: key);
            ...
            if (fromNames.isEmpty)
              ...
              ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  Future<String> assignationFuture = getAllChatDetails(conversationId);
                  ...
                  return FutureBuilder<String>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        return ConversationList(
                          ...
                          fromName: fromName,
                          assignation: assignation.isEmpty ? 'Free to assign' : 'Assigned to: ' + assignation,
