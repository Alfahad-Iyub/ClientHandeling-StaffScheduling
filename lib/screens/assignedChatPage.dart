...
class assignedChatPage extends StatefulWidget {
  final String username;

  const assignedChatPage({Key? key, required this.username}) : super(key: key);

  @override
  _assignedChatPageState createState() => _assignedChatPageState();
}

class _assignedChatPageState extends State<assignedChatPage> {

  bool _isAssignedChatsPage = true;
  Timer? _timer;
            ...
            if (fromNames.isEmpty)
              ...
              ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  Future<String> assignationFuture = getAssignedChatDetails(conversationId);

                  return FutureBuilder<String>(
                      future: assignationFuture,
